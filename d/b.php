...
<body>
<h1>ฟอร์มรับข้อมูล - ภัทรวดี ขามประโคน (การ์ตูน)</h1>
...
<!--<button type="button" onDblClick="alert('ล่ามเคะกั๊ก.');">Hello</button>-->
<button type="button"   onMouseOver="alert('ล่ามเคะกั๊ก');">Hello</button>
...
if (isset($_POST['Submit'])){
    ...
    echo "สีที่ชอบ: <div style='background-color:{$color};width:300px'>
 ".$color."</div>";
